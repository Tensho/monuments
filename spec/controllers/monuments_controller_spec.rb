...
RSpec.describe MonumentsController, :type => :controller do
  ...
  describe "GET show" do
    it "assigns the requested monument as @monument" do
      monument = Monument.create! valid_attributes
      get :show, {:id => monument.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested monument as @monument" do
      monument = Monument.create! valid_attributes
      get :edit, {:id => monument.to_param}, valid_session
      expect(assigns(:monument)).to eq(monument)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Monument" do
        expect {
          post :create, {:monument => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved monument as @monument" do
        post :create, {:monument => invalid_attributes}, valid_session
        expect(assigns(:monument)).to be_a_new(Monument)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested monument" do
        monument = Monument.create! valid_attributes
        put :update, {:id => monument.to_param, :monument => new_attributes}, valid_session
        monument.reload
      ...
      it "assigns the requested monument as @monument" do
        monument = Monument.create! valid_attributes
        put :update, {:id => monument.to_param, :monument => valid_attributes}, valid_session
        expect(assigns(:monument)).to eq(monument)
      end
    ...
    describe "with invalid params" do
      it "assigns the monument as @monument" do
        monument = Monument.create! valid_attributes
        put :update, {:id => monument.to_param, :monument => invalid_attributes}, valid_session
        expect(assigns(:monument)).to eq(monument)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested monument" do
      monument = Monument.create! valid_attributes
      expect {
        delete :destroy, {:id => monument.to_param}, valid_session
      }.to change(Monument, :count).by(-1)
    end
